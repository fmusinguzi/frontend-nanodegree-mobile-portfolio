...
var resizePizzas = function(size) {
  ...
  // Iterates through pizza elements on the page and changes their widths
    function changePizzaSizes(size) {
        ...
        //get one pizza element and use it to calculate the change
        var aPizza = pizzaContainers[0];
        var dx = determineDx(aPizza, size);
        for (var i = 0; i < pizzaContainers.length; i++) {
            pizzaContainers[i].getElementsByTagName("div")[0].style.transform = "scale(" + dx + ") translateZ(0)";
        }
    }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 20; i++) {
    ...
    movingElements.push(elem);
}
var moversContainer= document.querySelector("#movingPizzas1");
